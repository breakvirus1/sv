...
ALTER TABLE ordschema.order_items ADD COLUMN IF NOT EXISTS file_id BIGINT;
...
CREATE INDEX IF NOT EXISTS idx_order_items_file ON ordschema.order_items(file_id);
