...
CREATE INDEX idx_order_operations_order_item ON ordschema.order_item_operations(order_item_id);
CREATE INDEX idx_order_operations_operation_id ON ordschema.order_item_operations(operation_id);
